function kwh_drawChart(jsonDataChart, container_div_id) {
...
function kwh_year_drawChart(jsonDataChart, container_div_id) {
    var data = new google.visualization.arrayToDataTable([jsonDataChart.header].concat(jsonDataChart.body));
    ...
    var chart = new google.visualization.LineChart(document.getElementById(container_div_id));
